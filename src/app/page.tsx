...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-white overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[100vh] flex flex-col justify-center px-4">
        {/* Background Elements */}
        ...
        <div className="container relative mx-auto mt-24 sm:mt-16">
          <div className="max-w-4xl mx-auto">
            {/* Main Content */}
            <div className="text-center mb-12 space-y-8">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent px-4">
                WFLAer.space
              </h1>
              ...
              <div className="flex flex-wrap justify-center gap-4 px-4">
                <Link
                  href="/projects"
                  className="w-full sm:w-auto group px-6 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 text-center"
                >
                ...
                <a
                  ...
                  className="w-full sm:w-auto group px-6 py-3 rounded-lg border border-gray-200 text-gray-600 font-medium hover:border-blue-500 hover:text-blue-600 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 text-center"
                >
                  <span className="flex items-center justify-center gap-2">
            ...
            <div className="grid gap-6 px-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              {/* Contact Card */}
              <Link href="/contact" className="group p-6 bg-white rounded-xl border border-gray-100 hover:border-green-100 hover:shadow-lg hover:shadow-green-500/5 transition-all duration-300 sm:col-span-2 lg:col-span-1">
                <div className="mb-4">
